...
class UsersController extends Controller
{
    ...
    public function loginCRM(Request $request){
        ...
        if($user_info){
            if(env('APP_ENV', 'staging')=='production'){
                $tmp_link = 'https://crm.congnghegiaoduc.com/single-sign-on/';
            }else{
                $tmp_link = 'https://staging.congnghegiaoduc.com/single-sign-on/';
            }
            $data = (object)array(
                'status'=>1,
                'message'=>'',
    ...
    public function loginLeads(Request $request){
        ...
        if($user_info){
            if(env('APP_ENV', 'staging')=='production'){
                $tmp_link = 'https://lead.congnghegiaoduc.com/#/single-sign-on/';
            }else{
                $tmp_link = 'https://stg-lead.congnghegiaoduc.com/#/single-sign-on/';
            }
            $data = (object)array(
                'status'=>1,
                'message'=>'',
